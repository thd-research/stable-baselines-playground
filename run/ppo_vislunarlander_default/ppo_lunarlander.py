...
def main(args, **kwargs):
    ...
    if not args.notrain:
        ...
        model.save("./artifacts/checkpoints/ppo_lunarlander")
        ...
        if args.eval_checkpoint:
            ...
            model = PPO.load(f"./artifacts/checkpoints/ppo_lunarlander_{args.loadstep}_steps")
        else:
            model = PPO.load("./artifacts/checkpoints/ppo_lunarlander")
    ...
    if args.eval_name:
        file_name = f"ppo_lunarlander_eval_{args.eval_name}_seed_{args.seed}.pkl"
    else:
        file_name = f"ppo_lunarlander_eval_{args.loadstep}_seed_{args.seed}.pkl"
