...
from run.ppo_vismountaintcar_default.args_parser import parse_args, ExperimentConfig, PPOHyperparameters
...
def main(args, **kwargs):
    ...
    if not args.notrain:
        ...
        checkpoint_callback = CheckpointCallback(
            ...
            name_prefix="ppo_vismountain_car_lstm"
        )
        ...
        model.save("./artifacts/checkpoints/ppo_vismountain_car_lstm")
        ...
        if args.eval_checkpoint:
            ...
            model = PPO.load(f"./artifacts/checkpoints/ppo_vismountain_car_lstm_{args.loadstep}_steps",
                             device=args.ppo.device)
        else:
            model = PPO.load("./artifacts/checkpoints/ppo_vismountain_car_lstm",
                             device=args.ppo.device)
